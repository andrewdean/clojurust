...
;; cljrs port: scans are single-threaded — the replacement storage has no
;; parallel-scan participant machinery to test.
#?(:cljrsh nil :clj
...
;; cljrs port: scans are single-threaded — parallel chunking internals
;; (parallel-scan-participant-count, ordered-parallel-list-chunks) do not
;; exist in the replacement storage.
#?(:cljrsh nil :clj
